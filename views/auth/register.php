  ...
  <body>
    ...
    >
      ...
      <div class="login-card bg-white shadow p-5">
        <h3 class="fw-bold text-dark mb-1">WELCOME TO OUR STORE!</h3>
        <p class="text-muted mb-4">Register here.</p>
        ...
        <div class="mb-3">
          ...
          <button type="submit"name="register" class="btn btn-primary shadow-sm login-btn">
            Register
          </button>
